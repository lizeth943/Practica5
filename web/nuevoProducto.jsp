<%-- 
    ...
    Created on : 02-05-2020, 07:58:47 PM
    Author     : HP
--%>
...
<html>
    ...
    <body>
        <form action="NuevoProducto" method="POST">
            <table>
                <tr>
                    <td>Id</td><td><input type="text" name="id" value="" size="3" /></td>
                </tr>
                <tr>
                    <td>Descripcion</td><td><input type="text" name="descripcion" value="" size="30" /></td>
                </tr>
                <tr>
                    <td>Categoria</td>
                    <td>
                ...
                <tr>
                    <td>Cantidad</td><td><input type="text" name="cantidad" value="" size="5"/></td>
                </tr>
                <tr>
